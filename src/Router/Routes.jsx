...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "service/:id",
        loader: ({ params }) => fetch(`https://opinion-plug-server.vercel.app/services/${params.id}`),
      ...
      },
      {
        ...
        loader: (params) => fetch(`https://opinion-plug-server.vercel.app/reviews?serviceId=${params.serviceId}`),
      },
      {
        path: "myReviews",
        element: (
