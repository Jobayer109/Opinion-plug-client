...
const Banner = () => {
  return (
    <div>
      ...
      <div className="absolute w-[60%] p-8  px-36 rounded-lg left-60 top-2/3  border-b-4 border-red-600 text-center  hover:bg-gray-400 translate duration-500 ease-in shadow-xl bg-gray-300">
        ...
        <p className="text-sm mb-6 font-mono">
          No matter who are you, how much your age, where are you from; the platform 'Opinion plug'
          is always with you to train you and your mind to serve a better life. '
        </p>
